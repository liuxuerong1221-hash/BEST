    ...
    <main class="alert-detail__body">
      ...
      <section class="alert-detail__center">
        ...
        <div class="alert-pin" :style="{ left: '44%', top: '42%' }">
          <!-- 多圈扩散波纹 -->
          <div class="alert-pin__ring alert-pin__ring--1" />
          <div class="alert-pin__ring alert-pin__ring--2" />
          <div class="alert-pin__ring alert-pin__ring--3" />
          <!-- 底部光晕 -->
          <div class="alert-pin__glow" />
          <!-- 主图标 -->
          <svg class="alert-pin__icon" viewBox="0 0 64 64" fill="none" width="64" height="64">
            <defs>
              <radialGradient id="pin-bg" cx="50%" cy="50%" r="50%">
                <stop offset="0%"   stop-color="#FF2020" stop-opacity="0.35"/>
                <stop offset="100%" stop-color="#FF0000" stop-opacity="0"/>
              </radialGradient>
            </defs>
            <circle cx="32" cy="32" r="31" fill="url(#pin-bg)" stroke="rgba(255,72,72,0.7)" stroke-width="1.5"/>
            <path d="M32 14L46 40H18L32 14Z" fill="#FF3030"/>
            <path d="M32 14L46 40H18L32 14Z" fill="none" stroke="rgba(255,160,160,0.6)" stroke-width="1" stroke-linejoin="round"/>
            <path d="M32 26v8" stroke="white" stroke-width="2.5" stroke-linecap="round"/>
            <circle cx="32" cy="37.5" r="1.8" fill="white"/>
          </svg>
...
.alert-pin {
  ...
  &__glow {
    ...
    border-radius: 50%;
    transform: translate(-50%, -50%);
    background: radial-gradient(circle, rgba(255, 40, 40, 0.35) 0%, transparent 70%);
    pointer-events: none;
  }
  ...
  &__icon {
    ...
    z-index: 2;
    filter:
      drop-shadow(0 0 6px rgba(255, 48, 48, 1))
      drop-shadow(0 0 16px rgba(255, 48, 48, 0.7));
  }
